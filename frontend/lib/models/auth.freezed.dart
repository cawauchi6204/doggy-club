...
abstract class $AuthStateCopyWith<$Res> {
  ...
  @useResult
  $Res call({String? token, User? user, bool isLoading, String? error});
...
class _$AuthStateImpl implements _AuthState {
  const _$AuthStateImpl(
      {this.token, this.user, this.isLoading = false, this.error});
  ...
  @override
  String toString() {
    return 'AuthState(token: $token, user: $user, isLoading: $isLoading, error: $error)';
  }
  ...
  @JsonKey(ignore: true)
  @override
  int get hashCode => Object.hash(runtimeType, token, user, isLoading, error);
